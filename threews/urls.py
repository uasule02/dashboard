...
urlpatterns = [
    ...
    path('upload-file1', UploadView.as_view(template_name = 'pages/threews/upload-file.html'), name='upload'),
    path('upload-file', UploadView1.as_view(template_name = 'pages/threews/upload-demo.html'), name='upload1'),
